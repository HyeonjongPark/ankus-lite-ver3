...
sgsp_plus %>% select(item) %>% table
sgsp_plus %>% select(custclass) %>% table %>% sort
...
goods2020 = sgsp_plus %>% filter(item == it, custclass == cu, invoicedate >= "2020-01-01") %>% select(itemname) %>% unique()
goods2020 = goods2020$itemname
goods2020 %>% length

goods2019 = sgsp_plus %>% filter(item == it, custclass == cu, invoicedate >= "2019-01-01" & invoicedate <= "2019-03-01") %>% select(itemname) %>% unique()
goods2019 = goods2019$itemname
goods2019 %>% length

goods2018 = sgsp_plus %>% filter(item == it, custclass == cu, invoicedate >= "2018-01-01" & invoicedate <= "2018-03-01") %>% select(itemname) %>% unique()
goods2018 = goods2018$itemname
goods2018 %>% length

goods2017 = sgsp_plus %>% filter(item == it, custclass == cu, invoicedate >= "2017-01-01" & invoicedate <= "2017-03-01") %>% select(itemname) %>% unique()
goods2017 = goods2017$itemname
goods2017 %>% length

goods2016 = sgsp_plus %>% filter(item == it, custclass == cu, invoicedate >= "2016-01-01" & invoicedate <= "2016-03-01") %>% select(itemname) %>% unique()
goods2016 = goods2016$itemname
goods2016 %>% length

goods2015 = sgsp_plus %>% filter(item == it, custclass == cu, invoicedate >= "2015-01-01" & invoicedate <= "2015-03-01") %>% select(itemname) %>% unique()
...
for(hot_item in 1:(length(current_sell))) {
  ...
  sgsp270 = sgsp_plus %>% filter(item == it, custclass == cu, itemname == (current_sell[hot_item])) %>% 
...
mape_vec
write.csv(mape_vec, "./sg_amond_online_2020/mape_info.csv", encoding = "UTF-8")
